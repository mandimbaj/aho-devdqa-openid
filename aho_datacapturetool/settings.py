...
ALLOWED_HOSTS = ['localhost','127.0.0.1','af-aho-datacapturetool-dev.azurewebsites.net',]
...
# Alchemy custom user authentication and Password validation settings
DQUSER = os.environ['DBUSER']
DQPASS =os.environ['DBPASS']
DQDB = os.environ['DBNAME']
DQHOST = os.environ['DBHOST']
